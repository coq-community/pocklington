...
Lemma div_absexp_compat :
 forall (b : Z) (d : nat),
 Divides d (Z.abs_nat b) -> forall n : nat, Divides d (Z.abs_nat (Exp b (S n))).
Proof.
...
Lemma zdivdiv :
 forall a b : Z, ZDivides a b -> Divides (Z.abs_nat a) (Z.abs_nat b).
Proof.
   intros.
   elim H.
   intros d Hd.
...
Lemma divzdiv :
 forall a b : Z, Divides (Z.abs_nat a) (Z.abs_nat b) -> ZDivides a b.
Proof.
   intros.
   elim H.
   intros d Hd.
...
Proof.
   intros.
   elim (divdec (Z.abs_nat x) (Z.abs_nat d)).
...
Proof.
   ...
   elim (div_rem (Z.abs_nat d) (Z.abs_nat n)).
   ...
   assumption. change (Z.abs_nat d > Z.abs_nat 0) in |- *. apply gtzgt.
   apply Zlt_le_weak. apply Z.gt_lt. assumption. apply Zeq_le. reflexivity.
   assumption. apply Z.le_ge. assumption. apply Z.le_ge.
   ...
   apply Z.le_ge. apply Zlt_le_weak. apply Z.gt_lt. assumption.
   rewrite Znat.inj_S. unfold Z.succ in |- *. rewrite Zopp_mult_distr_l_reverse.
   ...
   split. split. unfold Z.le in |- *. simpl in |- *. discriminate.
   apply Z.le_lt_trans with (Z_of_nat rn).
   ...
   change (Z.abs_nat d > Z.abs_nat 0) in |- *. apply gtzgt. apply Zlt_le_weak.
